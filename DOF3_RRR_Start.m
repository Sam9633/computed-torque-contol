%% Introduction
% This file will first load the Rigid Body Tree object of the robot model
% from the SimScape model file. After that an slTuner object will be
% generated that will define the input and output of the system and later
% on will be tuned using H-infinity based optimization routine. Once tuning
% is complete the PID parameters will be written in the corresponding
% blocks and the manipulator will be simulated.
%
% Developed by: Muhammad Rzi Abbas
% Research Scholar: Human-Centered Robotics Lab, UET, Lahore
% Dated: 30-January-22
...
ST0 = slTuner('DOF3_RRR_PID',TunedBlocks);
...
RefSignals = {...
   'DOF3_RRR_PID/Signal Builder/q1', 'DOF3_RRR_PID/Signal Builder/q2', 'DOF3_RRR_PID/Signal Builder/q3'};
addPoint(ST0,RefSignals)

%% Defining Input and Outputs and Tuning the system

Controls = TunedBlocks;      % actuator commands
Measurements = 'DOF3_RRR_PID/Robot/qm';  % joint angle measurements
